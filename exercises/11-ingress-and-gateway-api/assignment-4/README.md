...
Complete `exercises/ingress-and-gateway-api/assignment-3` first. This assignment reuses Gateway API CRDs and vocabulary. Envoy Gateway from assignment 3 can stay installed; the tutorial runs NGINX Gateway Fabric alongside it.
