...
- I have completed helm/assignment-1 and assignment-2
...
- Basic installation (exercises/helm/assignment-1)
- Upgrade and rollback (exercises/helm/assignment-2)
...
4. **README File for the Assignment**
   ...
   - Prerequisites: helm/assignment-1, assignment-2
...
- **Prerequisites:**
  ...
  - exercises/helm/assignment-2: Helm lifecycle

- **Follow-up assignments:**
  - exercises/kustomize/assignment-1: Alternative manifest management
